...
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        xTabLineOffset=a.getDimensionPixelSize(R.styleable.XTabLayout_xTabLineOffset, 0);
    ...
    private TabView createTabView(@NonNull final XTabLayout.Tab tab) {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if(xTabLineOffset == 0){
                    ...
                    RectF oval3 = new RectF(tabCenter-xTabLineOffset, getHeight() - mSelectedIndicatorHeight,
                            mIndicatorRight-width/2+xTabLineOffset, getHeight());
