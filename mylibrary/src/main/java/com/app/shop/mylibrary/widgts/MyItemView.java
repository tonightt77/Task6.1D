...
public class MyItemView extends LinearLayout {
    ...
    public MyItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout rlViewitem = (RelativeLayout) view.findViewById(R.id.rl_viewitem);
        imgv_left = view.findViewById(R.id.imgv_left);
        tvLeft = view.findViewById(R.id.tv_viewitem_left);
        tvRight = view.findViewById(R.id.tv_viewitem_right);
        tv_line_bottom = view.findViewById(R.id.view_line_bottom);
        view_redpoint = view.findViewById(R.id.view_red_tips);
        imgv_right = view.findViewById(R.id.imgv_viewitem_right);
